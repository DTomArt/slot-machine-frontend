...
export class ReelsContainer extends Container {
    ...
    protected initWinLine() {
        const center = GameContainer.DESIGN_WIDTH / 2;
        const winLine = new Graphics()
            .beginFill(0xff0000)
            .drawRect(center, SYMBOL_SIZE * 1.5, REEL_WIDTH * 3 * GameContainer.spreadX, 3)
            .endFill();
        winLine.pivot.set(REEL_WIDTH * 1.5 * GameContainer.spreadX, 3);
